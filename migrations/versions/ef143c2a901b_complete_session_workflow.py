...
def upgrade() -> None:
    ...
    with op.batch_alter_table("session_manifests") as batch_op:
        batch_op.add_column(
            sa.Column("rubric_id", sa.String(100), nullable=False, server_default="startup_pitch")
        )
        batch_op.add_column(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("attempt_id", "speaker_label", name="uq_speaker_mapping_attempt_label"),
    )
