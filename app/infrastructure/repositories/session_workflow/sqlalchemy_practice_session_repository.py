...
class SqlAlchemyPracticeSessionRepository(PracticeSessionRepository):
    ...
    async def create(
        ...
        try:
            ...
            raise IdempotencyConflict("Practice session already exists or conflict.") from exc
        return to_domain(model)
    ...
    async def update(
        ...
        stmt = (
            ...
            .values(
                ...
                consent_policy_version=session.consent_policy_version,
                consent_confirmed_by=session.consent_confirmed_by,
        ...
        try:
            ...
            await self._session.rollback()
            raise IdempotencyConflict("Integrity conflict on practice session update.") from exc
