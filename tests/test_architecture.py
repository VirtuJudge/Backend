...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("application", "from app.application.interfaces.userRepository import UserRepository"),
        ...
        ("api", "from app.application.services.userService import UserService"),
        ("infrastructure", "from app.domain.user import User\nimport sqlalchemy"),
        ("infrastructure", "from app.application.interfaces.userRepository import UserRepository"),
    ],
)
...
def test_diagnostics_and_highest_seam(tmp_path: Path) -> None:
    ...
    files = {
        ...
        / "application"
        / "interfaces"
        / "bad.py": "from ..services.userService import UserService\n",
        synthetic
        / "application"
        / "ports"
        / "bad.py": "from app.application.services.userService import UserService\n",
